...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler("pipeline_g_greedy_classifier_f_execution.log", mode='a'), # Dedicated log file
...
def get_total_tagged_data_so_far(sub, llm, max_week_index, target_subsample):
    ...
    """
    directory_path = f'bootstrap_results_G-Greedy_classifier_f'
...
def save_weekly_results(weekly_data, week_index,subsample, sub, llm):
        output_directory = f'bootstrap_results_G-Greedy_classifier_f'
...
logger.info("=== Starting G-Greedy-classifier-f Pipeline Execution ===")
...
logger.info("=== G-Greedy-classifier-f Pipeline Execution Completed ===")